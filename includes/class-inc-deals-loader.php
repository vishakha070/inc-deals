...
class Inc_Deals_Loader {
	...
	public function add_shortcode( $hook, $component, $callback ) {
		$this->shortcodes = $this->inc_custom_add_shortcode( $this->shortcodes, $hook, $component, $callback );
	}
	 ...
	 */
	private function inc_custom_add_shortcode( $hooks, $hook, $component, $callback ) {
